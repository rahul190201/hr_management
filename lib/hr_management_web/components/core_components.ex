defmodule HrManagementWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(HrManagementWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(HrManagementWeb.Gettext, "errors", msg, opts)
    end
  end
